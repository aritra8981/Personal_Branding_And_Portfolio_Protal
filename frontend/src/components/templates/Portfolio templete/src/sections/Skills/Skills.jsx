  ...
  return (
    <section id="skills" className="s-container">
      ...
      <span>TypeScript</span>
        {/* <img src={checkMarkIconDark} alt="TypeScript" className ="Skill-icon"  /> */}
      <span>Node</span>
      ...
      <div className="skillList">
        ...
        <span>Angular</span>
        {/* <img src={checkMarkIconDark} alt="Angular" className ="Skill-icon"  /> */}
        <span>Vue</span>
        {/* <img src={checkMarkIconDark} alt="Vue" className ="Skill-icon"  /> */}
      </div>
      <hr />
      <div className="skillList">
        <span>Redux</span>
